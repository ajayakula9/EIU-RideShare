...
@Component({
  selector: 'app-ofrride',
  templateUrl: './ofrride.component.html',
  styleUrls: ['./ofrride.component.css']
})
export class OfrrideComponent implements OnInit, OnDestroy {
...
locationSubject: Subject<any>;
 ...
 ofrride(firstname,lastname, fplace, tplace, date,time,seates,phone,email) {
  this.getLocation(fplace,firstname)
  firebase.database().ref('oferride1/' + firstname).set({
  username: firstname,  
  fplace: fplace,
  tplace: tplace,
  date: date,
